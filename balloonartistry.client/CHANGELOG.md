...
- Create Angular project with ng: `ng new balloonartistry.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`balloonartistry.client.esproj`).
